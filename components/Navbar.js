...
import taxi from "../temp/taxi.jpg";
import { BsPerson } from 'react-icons/bs'
import { useContext } from 'react'
import { UberContext } from '../context/uberContext'

const style = {
  wrapper: `h-16 w-full bg-black text-white flex md:justify-around items-center px-4 fixed z-20`,
  leftMenu: `flex gap-3`,
  ...
  return (
    <div className={style.wrapper}>
      ...
      <div className={style.userImageContainer}>
        ...
        <div className={style.logo}>MyTaxi</div>
        <div className={style.menuItem}>Ride</div>
        <div className={style.menuItem}>Drive</div>
        <div className={style.menuItem}>Bookings</div>
      </div>
      <div className={style.rightMenu}>
        ...
        {currentAccount ? (
          ...
          <div className={style.loginButton} onClick={() => connectWallet()}>
            ...
            <span className={style.loginText}>Wallet</span>
          </div>
        )}
      </div>
    </div>
